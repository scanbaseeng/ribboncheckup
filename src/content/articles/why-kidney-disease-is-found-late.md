---
title: Why Kidney Disease Is Found Late, and What Would Change That
...
**Home testing.** A uACR can be run on a strip at home, with or without a phone app that reads the color. Mail in kits return a lab result. Home testing removes the bathroom trip and the separate order. The result still needs to be confirmed and acted on by a clinician, but it gets the number into the conversation. See [kidney health urine tests](/health-explained/kidney-health-urine-tests/) for how the home versions work.
